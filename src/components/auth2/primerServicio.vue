  ...
  >
    ...
    >
      ...
      <div class="card mb-4 shadow-sm"   
          ...
          :key="index"
          v-if="articulo.estado === 1 && articulo.categoria.nombre === 'Factura Electrónica'"
         >
        ...
        <div class="card-body">
          <h1 class="card-title pricing-card-title">{{articulo.codigo}} <small class="text-muted">/ mes</small></h1>
