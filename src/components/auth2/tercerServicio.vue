  ...
  >
    ...
    >
      ...
      <div class="card mb-4 shadow-sm"   
          ...
          :key="index"
          v-if="articulo.estado === 1 && articulo.categoria.nombre === 'Seguridad y distribución de datos'"
         >
        <div class="card-header"
        >
          <h4 class="my-0 font-weight-normal">{{articulo.nombre}}</h4>
        </div>
        <div class="card-body">
          <h2 class="card-title pricing-card-title">{{articulo.codigo}} <small class="text-muted">/ mes</small></h2>
          <p>
